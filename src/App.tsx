...
function SharkLogo() {
  return (
    <img
      ...
      src={new URL("./assets/icons/128x128.png", import.meta.url).href}
...
function App() {
  ...
  const selectChart = (kind: ChartKind) => {
    setChart(kind);
    if (pane === "learn") setPane("structure");
  };
  const noChartData =
  ...
  const canExportFigure = exportReady && pane !== "learn" && !noChartData;
  ...
  const save = () =>
    perform(async () => {
      const path = await saveText(
        ...
        await invoke<string>("serialize_project", { project }),
      );
  ...
  const paneTitles: Record<Pane, [string, string]> = {
    ...
    settings: ["SETTINGS", "Solver and appearance"],
  ...
  return (
    ...
    >
      <aside className="rail">
        ...
        <button
          className={pane === "structure" ? "active" : ""}
        ...
        <button
          className={pane === "quantum" ? "active" : ""}
          onClick={() => setPane("quantum")}
          title="Quantum"
          aria-label="Quantum"
        >
          <Atom />
        ...
        <span />
        <button
          className={pane === "learn" ? "active" : ""}
          onClick={() => setPane("learn")}
          title="Learn and About"
          aria-label="Learn and About"
        >
          <BookOpen />
        </button>
      </aside>
      ...
      <section className="sidebar">
        ...
        {pane === "structure" && (
          <>
                  ...
                  onClick={() =>
                    patch({
                      mesh_spacing_nm: Math.max(
                        0.1,
                        Math.min(...project.layers.map((l) => l.thickness_nm)) /
                          100,
                      ),
                    })
                  }
            ...
            {layer && (
              <div className="editor" key={selected}>
                ...
                {layer.charge_mode === "fixed_volume" ? (
                  ...
                  <>
                    <NumberInput
                      ...
                      unit="cm⁻³"
                      onChange={(v) => patchLayer(selected, { donors_cm3: v })}
                    />
                    <NumberInput
                      label="Acceptors Nₐ"
            ...
            <div className="editor compact">
                  ...
                  <label className="field">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="fixed_potential">Fixed potential</option>
              ...
              {project.substrate.kind !== "zero_field" && (
                <NumberInput
                  ...
                  unit="V"
                  onChange={(v) =>
                    patch({ substrate: { ...project.substrate, voltage_v: v } })
                  }
                />
              )}
        ...
        {pane === "learn" && (
          <div className="learn-pane">
            ...
            <div className="learn-equation">
              ...
              <p>
                Poisson’s equation converts charge into electrostatic potential
                and band bending.
              </p>
            </div>
            <div className="learn-equation">
              ...
              <p>
                The effective-mass Schrödinger equation finds confined electron
      ...
      <section className="workspace">
            ...
            },
            {
              ...
              items: [
                ...
                },
                {
                  label: "Sweep as CSV",
                  action: sweepCsv,
                  disabled: !exportReady || !result?.sweep.length || busy,
                },
                {
                ...
                },
                {
                  label: "Report as PDF…",
                  action: pdf,
                  disabled: !exportReady || pane === "learn" || busy,
                },
              ],
            },
            {
        ...
        {pane !== "learn" && (
          <div className="status" role="status" aria-live="polite">
            ...
            {result && !stale && (
              <>
                <i /> {result.convergence.iterations} iterations <i /> residual{" "}
                {result.convergence.residual.toExponential(2)}
              </>
            )}
          </div>
        )}
        {pane === "learn" && (
          <article className="guide">
            <header>
              ...
              <p>
                A practical guide to the physical models, controls, figures, and
                limits of Requin.
              </p>
            </header>
            <section className="guide-grid">
              <div>
                ...
                <p>
                  Layers are ordered from the exposed surface to the substrate.
                  Give every layer a material, thickness, and donor or acceptor
                  concentration. Alloy fraction <MathText tex="x" /> controls
                  ternary materials such as <MathText tex="Al_xGa_{1-x}As" />.
                </p>
              </div>
              <div>
              ...
              <div>
                ...
                <p>
                  Every edit starts a coarse preview, followed by a full solve.
                  Use results quantitatively only when the status reads
            ...
            <section className="theory">
              <div>
                ...
                <p>
                  ...
                  then change the charge, so the solver iterates to consistency.
                </p>
              </div>
              <div>
                ...
                />
                <p>
                  The single-band, position-dependent effective-mass Hamiltonian
                  returns bound electron energies and normalized wavefunctions
            ...
            <section className="reading-guide">
              ...
              <div>
                <b>Carrier density</b>
                <p>
                  <MathText tex="n" /> and <MathText tex="p" /> use logarithmic
                  scaling. Compare them with doping to identify accumulation,
            ...
            <section className="limits">
              ...
              <p>
                ...
                Schottky thermionic emission. It does not yet include multiband
                k·p, tunneling/NEGF, avalanche, transient heating, or lateral
                MOSFET/HEMT drain transport. Built-in material values are
                curated defaults and should be overridden with source-specific
                parameters for publication work.
              </p>
            </section>
          </article>
        )}
        <article
          className="report"
          style={{ display: pane === "learn" ? "none" : undefined }}
        >
          <div className="report-title">
            <div>
              <small>
                REQUIN COMPUTATIONAL REPORT · {new Date().toLocaleDateString()}
              </small>
              <h2>
                {project.analytic_verification
          ...
          <section className="figure">
            ...
            {noChartData ? (
              <div className="empty">
                ...
                <button
                  onClick={() => {
                    ...
                    requestAnimationFrame(() =>
                      document
                        .querySelector(
                          chart === "wave" ? ".prominent" : ".editor.compact",
                        )
                        ?.scrollIntoView({
                          block: "center",
                          behavior: "smooth",
                ...
                >
                  Open {chart === "wave" ? "quantum" : "experiment"} settings
                </button>
              </div>
            ) : result ? (
            ...
            <p className="caption">
              Position increases from the metal toward the semiconductor. Dashed
              vertical markers show every layer or charge-region boundary.
              Voltage-drop cards use the textbook convention: left endpoint
              potential minus right endpoint potential.
            </p>
          </section>
          {result?.analytic && (
            <>
              <div className="verification-grid">
                ...
                <div>
                  ...
                  <b>
                    {compact(result.analytic.semiconductor_voltage_v ?? NaN)} V
                  </b>
                </div>
                <div>
                  <small>OXIDE FIELD</small>
                  <b>{compact(result.analytic.oxide_field_v_cm ?? NaN)} V/cm</b>
                </div>
                <div>
                  <small>METAL σ</small>
                  <b>
                ...
                <div>
                  ...
                  <b>{compact(result.analytic.max_field_error_v_cm)} V/cm</b>
                </div>
              </div>
              <details className="derivation">
                <summary>Equations, superposition, and sign convention</summary>
                <div>
                  <MathText
                    display
                    tex={
                  ...
                  />
                  <p>
                    The potential reference is φ(0)=0; adding any constant gives
                    an equivalent solution. Potential is continuous. With no
                    interface sheet charge, normal displacement D is continuous
                    even though E changes at the SiO₂/Si boundary. The displayed
                    metal charge balances the integrated semiconductor charge.
                    The same result follows by superposing the field of the
                    metal sheet and the uniformly charged silicon slab region by
                    region.
                  </p>
                </div>
              </details>
              ...
              >
                ...
                <div>
                      ...
                      <tbody>
                        {result.position_nm.slice(0, 250).map((x, i) => (
                          <tr key={i}>
                            ...
                            <td>{compact(result.electric_field_v_cm[i])}</td>
                            <td>{compact(result.charge_density_c_cm3[i])}</td>
                  ...
                  {result.position_nm.length > 250 && (
                    <p>
                      Showing the first 250 points. Export → Data as CSV writes
                      the complete numerical and analytic data.
                    </p>
                  )}
                </div>
              </details>
